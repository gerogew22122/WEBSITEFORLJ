    ...
    <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black overflow-hidden transition-opacity duration-700 font-sans ${fadeOut ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl">
        ...
        <div className="space-y-8">
          <h1
            className={`${inter.className} font-light tracking-wide text-3xl sm:text-4xl md:text-6xl lg:text-7xl text-white transition-all duration-1000 leading-tight px-4 ${
              stage >= 2 && stage < 3
          ...
          >
            <h2
              className={`${inter.className} font-black text-[6rem] sm:text-[8rem] md:text-[12rem] lg:text-[16rem] leading-none bg-gradient-to-b from-[#93c5fd] via-[#3b82f6] to-[#1e40af] bg-clip-text text-transparent`}
              style={{
